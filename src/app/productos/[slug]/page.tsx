...
export default function ProductDetailPage({
  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-16 text-[var(--color-text-primary)]">
      ...
      <p className="mt-4 text-[var(--color-text-secondary)]">{product.summary}</p>
      ...
      >
        ...
        <p className="mt-3 text-sm leading-7 text-[var(--color-text-secondary)]">
          Cuando esta línea tenga versión beta estable, abriremos agenda para demo.
        </p>
        <a
          ...
          href={`mailto:hola@bhrkcodelabs.com?subject=Interes%20en%20demo%20beta%20-%20${encodeURIComponent(product.name)}&body=Hola%20BHRK%2C%20quiero%20agendar%20demo%20cuando%20haya%20beta%20de%20${encodeURIComponent(product.name)}.`}
        >
          Solicitar demo beta
        </a>
      </section>
