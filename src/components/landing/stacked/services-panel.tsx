...
function ServicesView({
  ...
  const narrative = [
    "Diagn�stico y criterio antes de mover presupuesto.",
    "Arquitectura para crecer sin romper continuidad.",
    "Flujos conectados para operar con menos fricci�n.",
    "Conversaciones �tiles para soporte y operaci�n.",
    "Capacidad t�cnica que entra y suma desde el d�a uno.",
